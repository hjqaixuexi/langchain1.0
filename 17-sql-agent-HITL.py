...
from langchain.agents.middleware import HumanInTheLoopMiddleware  # ty: ignore
from langchain.chat_models import init_chat_model  # ty: ignore
from langchain_community.agent_toolkits import SQLDatabaseToolkit  # ty: ignore
from langchain_community.utilities import SQLDatabase  # ty: ignore
from langgraph.checkpoint.memory import InMemorySaver  # ty: ignore
from langgraph.types import Command  # ty: ignore

load_dotenv()

model = init_chat_model(model="deepseek:deepseek-chat", temperature=0.1)
